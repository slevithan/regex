...
- `regex` relies on flag <kbd>v</kbd> (`unicodeSets`), which has had universal browser support since ~mid-2023 and is available in Node.js 20+. But it's possible to make it work in older browsers (see [#2](https://github.com/slevithan/regex/issues/2)).
